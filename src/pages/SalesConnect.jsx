    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      {showVideo && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
          ...
          <div className="w-[340px] sm:w-[380px] md:w-[420px] aspect-[9/16] bg-black rounded-xl overflow-hidden shadow-2xl">
            <video
              src={demoVideo}
              controls
              autoPlay
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  We recognise the challenges brands face in managing sales and distribution.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  onClick={() => setShowVideo(false)}
                  className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg text-lg font-semibold hover:border-blue-500 hover:text-blue-600"
                >
                  Watch Demo
                </button>
              </div>
