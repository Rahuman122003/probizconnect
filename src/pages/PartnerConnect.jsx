  ...
  const features = [
    {
      ...
      description:
        "Partners serve as the vital bridge between your business and end consumers, facilitating seamless product promotion and purchase experiences.",
    ...
    },
    {
      ...
      description:
        "Handle visual merchandising strategies to maximize performance and profits, as product visibility is crucial for consumers.",
    ...
    },
    {
      ...
      description:
        "Enhance relationships with partners through comprehensive loyalty programs and reward mechanisms for better customer engagement.",
    ...
    },
    {
      ...
      description:
        "Partners manage the complete purchase journey, serving as the single point of contact for end consumers.",
    ...
    },
    {
      ...
      description:
        "Partner Connect enables you to focus on manufacturing and distribution while partners handle market-facing activities.",
    ...
    },
    {
      ...
      description:
        "Leverage partner networks to expand market reach without the enormous effort of direct selling to consumers.",
  ...
  const partnerTypes = [
    {
      ...
      description:
        "Take control of your market presence with an easy-to-setup loyalty program that enhances partner connect and incorporates effective reward mechanisms for your partners.",
    ...
    },
    {
      ...
      description:
        "Implement reward mechanisms by awarding points for completing specific tasks or actions, such as scanning a coupon placed inside products like paints or tanks. This strategy can enhance loyalty programs and encourage customer engagement through partner connect initiatives.",
    ...
    },
    {
      ...
      description:
        "Bring all your channel partners, including dealers, distributors, and influencers, onto a single platform to enhance partner connect through effective loyalty programs and reward mechanisms.",
  ...
  const benefits = [
    {
      ...
      description:
        "Eliminate the enormous effort required to sell products directly to market without partners",
    ...
    },
    {
      ...
      description:
        "Partners ensure crucial product visibility through strategic visual merchandising",
    ...
    },
    {
      ...
      description:
        "Build lasting customer relationships through partner loyalty programs and rewards",
  ...
  const faqs = [
    {
      ...
      answer:
        "Partners serve as the bridge between you and your end consumers, handling direct interactions, product promotion, and purchases. Without partners, you would need enormous effort to sell products directly to market, making partner networks crucial for efficient market reach.",
    },
    {
      question: "How do visual merchandising and planograms work?",
      answer:
        "Partners handle visual merchandising strategies including planogram implementation to maximize performance and profits. Product visibility is crucial for consumers, and strategic placement through visual merchandising significantly impacts sales success.",
    },
    {
      question: "What loyalty programs and rewards are available for partners?",
      answer:
        "We offer comprehensive loyalty programs and reward mechanisms that enhance relationships with partners, enabling them to better engage with customers. These programs include performance-based incentives, recognition systems, and exclusive benefits.",
    },
    {
      question: "How does Partner Connect help focus on core business?",
      answer:
        "Partner Connect enables you to focus on manufacturing and distribution of your goods while partners handle market-facing activities. This delegation allows you to concentrate on what you do best while leveraging partner expertise for customer engagement.",
    },
    {
      question: "What support is provided to partners?",
      answer:
        "We provide comprehensive support including training programs, marketing materials, technical assistance, performance analytics, and dedicated account management. Our 24/7 support ensures partners have everything they need to succeed.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8">
              Partners are the bridge between you and your end consumers. They
              interact with end consumers, promote products, and handle the
              single point of purchase. Imagine the enormous effort you would
              need without partners or resellers to sell your products to
              market.
            </p>
              ...
              <div
                ...
                className={`text-center group hover:transform hover:scale-105 transition-all duration-500 p-8 rounded-3xl ${
                  currentPartner === index
                    ? "bg-gradient-to-br from-blue-50 to-purple-50 ring-4 ring-blue-200"
                    : "bg-gray-50"
                }`}
                onMouseEnter={() => handleCardHover(`type-${index}`)}
              >
                <div
                  className={`w-24 h-24 ${type.bgColor} rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:shadow-lg transition-all duration-300 ${animatedCards[`type-${index}`] ? "animate-pulse" : ""}`}
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {benefits.map((benefit, index) => (
              ...
              >
                <div
                  className={`w-32 h-32 bg-gradient-to-r ${benefit.gradient} rounded-full flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-all duration-500 shadow-2xl ${animatedCards[`benefit-${index}`] ? "animate-bounce" : ""}`}
                >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
            Stop exerting enormous effort to sell directly to market. Let our
            Partner Connect platform bridge you to success through strategic
